...
path_wd <- "/data/salomonis2/LabFiles/Kyle/Development/infinityFlow/R/test_scripts/mouse_lung_dataset_separate_directories/subset_50_features"
prefix_input <- "subset_50_features"
iso_anno <- read.csv("/data/salomonis2/LabFiles/Kyle/Development/pyInfinityFlow/data/mouse_lung_dataset_annotations/infinitymarker_annotation_50_feature_subset.csv")
...
path_flow_data <- "/data/salomonis2/LabFiles/Kyle/Analysis/2022_08_24_infinity_flow_benchmarking/input/original_infinity_flow_paper/mouse_lung_steady_state/backbone_subset_50"

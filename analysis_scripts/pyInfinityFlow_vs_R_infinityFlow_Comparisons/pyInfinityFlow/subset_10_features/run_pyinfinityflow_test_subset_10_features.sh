...
--out_dir /data/salomonis2/LabFiles/Kyle/Development/pyInfinityFlow/test_scripts/mouse_lung_dataset/subset_10_features/output/ \
...
--infinity_marker_annotation /data/salomonis2/LabFiles/Kyle/Development/pyInfinityFlow/data/mouse_lung_dataset_annotations/infinitymarker_annotation_10_feature_subset.csv \

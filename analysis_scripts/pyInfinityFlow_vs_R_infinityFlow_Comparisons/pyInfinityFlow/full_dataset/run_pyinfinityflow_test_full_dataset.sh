...
--out_dir /data/salomonis2/LabFiles/Kyle/Development/pyInfinityFlow/test_scripts/mouse_lung_dataset/full_dataset/output/ \
...
--infinity_marker_annotation /data/salomonis2/LabFiles/Kyle/Development/pyInfinityFlow/data/mouse_lung_dataset_annotations/infinitymarker_annotation_full_mouse_lung_dataset.csv \
